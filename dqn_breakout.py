...
class BreakoutProcessor(Processor):
    ...
    def process_observation(self, observation):
        ...
        img = Image.fromarray(observation, 'RGB') # change numpy array to image object
...
def main():
    ...
    parser.add_argument('--policy-value-test', type=float, default=0.5)
    parser.add_argument('--policy-nb-steps', type=int, default=1000000)
